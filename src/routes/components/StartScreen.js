    ...
    render() {
        return (
            <div className="startScreen">
                ...
                <p className="explainText">Je kan
                    een naam zoeken in het zoekveld. Dit kan bijvoorbeeld je gemeente, of buurt naam zijn. Probeer
                    verschillende dingen
                    en zie wat je kan ontdekken.</p>
